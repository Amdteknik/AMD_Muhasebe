...
class AlacaklarPopup(Popup):
    def __init__(self, **kwargs):
        ...
        self.dinamik_url = f"{base}/{isletme}/satis_faturalari"

        # __init__ içinde
        self.lbl_tahmini_alacak = Label(
            text="TAHMİNİ GELECEK: 0,00 TL", 
            bold=True, 
            halign='left', 
            color=(0, 1, 0.8, 1), 
            font_size='14sp'
        ...
        self.lbl_toplam_alacak = Label(text="TOPLAM ALACAK: 0,00 TL", bold=True, halign='left', valign='middle', font_size='14sp')
        self.lbl_toplam_alacak.bind(size=lambda i, v: setattr(i, 'text_size', (v[0], v[1])))
        
        self.lbl_tahmini_alacak = Label(text="TAHMİNİ GELECEK: 0,00 TL", bold=True, halign='left', valign='middle', color=(0, 1, 0.8, 1), font_size='14sp')
        self.lbl_tahmini_alacak.bind(size=lambda i, v: setattr(i, 'text_size', (v[0], v[1])))
        
        bilgi_kutusu.add_widget(self.lbl_toplam_alacak)
        bilgi_kutusu.add_widget(self.lbl_tahmini_alacak)
    ...
    def verileri_yukle(self):
        ...
        try:
            ...
            self.lbl_toplam_alacak.text = f"TOPLAM ALACAK: {format_tr(genel_toplam)}"
    ...
    def fatura_secim_kontrol(self, checkbox, value):
        ...
        self.lbl_tahmini_alacak.text = f"TAHMİNİ GELECEK: {format_tr(max(0, self.tahmini_toplam_genel))}"
...
# Bu fonksiyonu AlacaklarPopup sınıfının içine yerleştirin
